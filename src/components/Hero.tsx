...
import { Github, Linkedin, Eye, FileText, Download } from 'lucide-react';

const Hero = () => {
  const handleResumeView = () => {
    window.open('/Angel_Moncada_CV.pdf', '_blank');
  };

  const handleResumeDownload = () => {
    const link = document.createElement('a');
    link.href = '/Angel_Moncada_CV.pdf';
    link.download = 'Angel_Moncada_CV.pdf';
    link.click();
  };
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-36">
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            {/* Update hero heading with Ángel Moncada's name */}
            <span className="block">Hi, I'm Ángel Moncada</span>
            {/* Update tagline to reflect Angel's background as a systems engineering student and full‑stack developer */}
            <span className="block mt-2 bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">Full‑stack developer and Software Engineer.</span>
          </motion.h1>
          ...
          >
            ...
            {/* Update animated text phrases to align with Angel's expertise */}
            <AnimatedText 
              text={[
          ...
          >
           I'm passionate about building clean, efficient and visually compelling solutions while applying engineering logic across the stack. I have an analytical and adaptable mindset and I'm always looking for new challenges to keep growing professionally.
          </motion.p>
          ...
          >
            {/* Update social links to Angel's profiles */}
            <a href="https://github.com/Angelfmoncada" target="_blank" rel="noopener noreferrer" className="group">
            ...
            <a href="https://www.linkedin.com/in/angel-moncada" target="_blank" rel="noopener noreferrer" className="group">
              <div className="relative p-3 rounded-xl bg-black/40 backdrop-blur-sm border border-blue-500/20 shadow-[0_0_15px_rgba(59,130,246,0.1)] group-hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600/0 via-blue-600/10 to-purple-600/0 rounded-xl blur-3xl opacity-0 group-hover:opacity-100 transition-all duration-500 scale-150 group-hover:scale-100"></div>
