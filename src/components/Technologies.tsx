                      ...
                      <motion.img 
                        ...
                        className={`w-10 h-10 object-contain relative z-10 transition-all duration-300 ${
                          tech.name === 'Express.js' 
                            ? 'filter brightness-0 invert drop-shadow-[0_0_12px_rgba(255,255,255,0.8)] group-hover:drop-shadow-[0_0_20px_rgba(255,255,255,1)] group-hover:brightness-125'
                            : 'filter drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] group-hover:drop-shadow-[0_0_15px_rgba(59,130,246,0.6)]'
                        }`}
