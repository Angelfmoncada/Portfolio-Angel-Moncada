...
export default function FeaturesSectionDemo() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Experienced in building performant, responsive mobile applications using Flutter, Kotlin, and React Native. Skilled in crafting modern UIs, integrating APIs, managing local and cloud data, and publishing apps to stores.",
      icon: <IconDeviceMobile className="w-6 h-6" />,
    },
    {
      title: "Project Leadership",
      description:
        "Capable of leading end-to-end project development—from planning and architecture to deployment—ensuring delivery of high-quality, scalable software solutions with Agile methodologies and team collaboration tools.",
      icon: <IconTarget className="w-6 h-6" />,
    },
    {
      title: "Analytics & Monitoring",
      description:
        "Skilled in implementing analytics solutions using tools like Firebase, Google Analytics, and monitoring systems to track app performance, user behavior, and ensure data-driven improvements.",
      icon: <IconChartBar className="w-6 h-6" />,
    },
    {
      title: "UI/UX Design Integration",
      description:
        "Experienced in working closely with designers or implementing UI/UX design systems. Focused on delivering accessible, pixel-perfect user interfaces across web and mobile platforms.",
      icon: <IconBrush className="w-6 h-6" />,
    },
  ];
